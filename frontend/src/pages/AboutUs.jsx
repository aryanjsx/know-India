...
const AboutUs = () => {
    ...
    const stats = [
        { number: "28", label: "States & UTs", icon: MapPin },
        { number: "100+", label: "Tourist Places", icon: Target },
    ...
    const values = [
        {
            icon: Target,
            title: "Our Mission",
            description: "To create an immersive digital experience that educates and inspires people about India's rich history, traditions, and landmarks.",
            color: "from-blue-500 to-cyan-500"
        },
        {
            icon: Sparkles,
            title: "Our Vision",
            description: "To become the go-to platform for anyone seeking to explore and understand the incredible diversity of Indian culture and heritage.",
                ...
                <div className="absolute inset-0">
                    ...
                    <motion.div 
                        ...
                        className={`absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl ${
                            isDark ? 'bg-orange-500/20' : 'bg-gradient-to-br from-orange-400/50 to-amber-300/40'
                        }`}
                    />
                    <motion.div 
                        animate={{ 
                        ...
                        className={`absolute top-40 right-20 w-96 h-96 rounded-full blur-3xl ${
                            isDark ? 'bg-amber-500/15' : 'bg-gradient-to-br from-rose-400/40 to-pink-300/30'
                        }`}
                    />
                    <motion.div 
                        animate={{ 
                        ...
                        className={`absolute bottom-20 left-1/3 w-80 h-80 rounded-full blur-3xl ${
                            isDark ? 'bg-rose-500/15' : 'bg-gradient-to-br from-amber-400/40 to-yellow-300/30'
                        }`}
                    />
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <p className={`text-lg md:text-xl leading-relaxed mb-10 max-w-xl ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                                    Two passionate developers on a mission to showcase the rich cultural heritage and breathtaking diversity of India through innovative technology.
                                </p>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <motion.a
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        href="#team"
                                        className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold rounded-full shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transition-shadow"
                                    >
                                        Meet the Team
                                    ...
                                    <motion.a
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        href="/places"
                                        className={`inline-flex items-center gap-2 px-8 py-4 font-semibold rounded-full border-2 transition-all ${
                                            isDark 
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {stats.map((stat, index) => (
                                        <motion.div
                                            ...
                                            className={`relative p-6 rounded-3xl backdrop-blur-xl overflow-hidden group cursor-pointer transition-all duration-300 ${
                                                isDark 
                                        ...
                                        >
                                            ...
                                            <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                                                index === 0 ? 'bg-gradient-to-br from-amber-500/15 to-transparent' :
            ...
            isDark 
                                ...
                                <motion.div
                                    ...
                                    className={`absolute -top-4 -right-4 px-4 py-2 rounded-full shadow-lg ${
                                        isDark ? 'bg-gradient-to-r from-amber-500 to-orange-500' : 'bg-gradient-to-r from-amber-500 to-orange-500'
                                    }`}
                                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {values.map((value, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className={`relative p-8 rounded-2xl group hover:-translate-y-2 transition-all duration-300 ${
                                    isDark ? 'bg-gray-800 hover:shadow-xl hover:shadow-amber-500/10' : 'bg-gray-50 hover:shadow-xl'
                                }`}
                            >
                ...
                <motion.div
                    ...
                    >
                        ...
                        Our Story
                            ...
                            {/* Quote */}
                            <div className={`mt-10 p-6 rounded-2xl border-l-4 border-amber-500 ${
                                isDark ? 'bg-amber-500/10' : 'bg-amber-50'
                            }`}>
                                <p className={`text-lg italic ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                                    "Unity in Diversity is not just a slogan for India, it's our way of life. Through Know India, we aim to celebrate this beautiful diversity."
                                </p>
                    ...
                    <div className={`p-12 rounded-3xl bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 relative overflow-hidden`}>
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                                Discover the incredible diversity of Indian states, their cultures, traditions, and hidden gems waiting to be explored.
                            </p>
                            <a 
                                href="/places"
