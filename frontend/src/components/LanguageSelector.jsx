 ...
 * 
 * A dropdown component for selecting the display language.
 * Integrates with LanguageContext to manage language state.
 * 
 * Features:
 * - Multiple display variants (full, compact, icon)
 ...
 * 
 * @param {Object} props
 * @param {string} props.variant - Display variant: 'full' | 'compact' | 'icon'
...
function LanguageSelector({ variant = 'full', className = '' }) {
  ...
  // ---------------------------------------------------------------------------
  // LANGUAGE LIST (sorted alphabetically)
  // ---------------------------------------------------------------------------
